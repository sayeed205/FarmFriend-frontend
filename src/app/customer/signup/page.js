...
function SignUp() {
    ...
    const handleSubmit = async () => {
        const data = await fetch('/api/customer/signup', {
            method: 'POST',
            headers: {
    ...
    return (
        <section className='p-2 rounded-md bg-black/80'>
            <div className='flex items-center justify-center px-4 py-10 bg-white sm:px-6 sm:py-16 lg:px-8'>
