...
const Footer = (props: Props) => {
    return (
        <footer className="text-gray-600 bg-slate-800 body-font">
            {/* <div className="h-[1px] w-full bg-gray-500 pointer-events-none"></div> */}
            ...
            <div className="bg-gray-900">
                <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                    <p className="text-gray-400 text-sm text-center sm:text-left">
                        © 2023 Farmer Friend - <span className="text-gray-500">team Code Morphers</span>
                    </p>
